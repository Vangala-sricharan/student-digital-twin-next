  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/90 dark:bg-[#02040a]/90 border-b border-slate-200/90 dark:border-white/10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-13 sm:h-14 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-5 text-[11px] font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider">
          <button
          ...
          <span className="w-px h-3.5 bg-slate-200 dark:bg-white/10 mx-0.5" />

          {/* Try Demo Button in Nav */}
          <button
            onClick={() => handleNavClick('/demo')}
            className="bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 px-2.5 py-1.2 rounded-lg transition-colors text-slate-800 dark:text-white text-[11px] font-semibold cursor-pointer flex items-center gap-1.5 shadow-2xs"
          >
            <Play className="w-2.5 h-2.5 fill-current text-blue-600 dark:text-cyan-400" />
            <span>Try Demo</span>
          </button>
        </nav>
        ...
        <div className="hidden sm:flex items-center gap-2 sm:gap-2.5">
          ...
          <button
            ...
            className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors text-[11px] font-semibold uppercase tracking-wider cursor-pointer flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 whitespace-nowrap"
          >
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-500 text-white px-3 sm:px-3.5 py-1.5 rounded-lg text-[11px] font-bold transition-all shadow-[0_4px_14px_rgba(37,99,235,0.4)] cursor-pointer flex items-center gap-1.5 uppercase tracking-wider whitespace-nowrap"
          >
            <span>SIGN UP</span>
