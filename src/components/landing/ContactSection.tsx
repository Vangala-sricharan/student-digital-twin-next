    ...
    <section id="contact" className="py-20 lg:py-28 bg-white dark:bg-[#02040a] transition-colors">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-14 max-w-2xl mx-auto">
          <div className="rounded-2xl bg-white dark:bg-[#0b0f19] border border-slate-200/90 dark:border-white/10 shadow-lg dark:shadow-2xl p-8 sm:p-10 transition-colors">
            ...
            {status === 'submitted' ? (
              <div className="text-center py-10 space-y-4">
                ...
                <button
                  ...
                  className="mt-4 px-5 py-2.5 rounded-xl bg-white dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 text-xs font-semibold text-slate-800 dark:text-white border border-slate-200 dark:border-white/10 transition-colors shadow-xs cursor-pointer"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-300/80 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500 text-sm transition-all font-mono"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-300/80 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500 text-sm transition-all resize-none font-mono"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-wider shadow-[0_4px_14px_rgba(37,99,235,0.4)] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {status === 'submitting' ? (
